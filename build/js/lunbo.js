  ...
  function scroll($container, direction) {
    ...
    $container.find('ul li').each(function (index, element) {
      ...
      if (i !== undefined) {
        ...
        // $(element).attr('data-i', zIndexs[i] + 100)


        $(element).attr('data-i', i)
        $(element).removeClass('active')
        $(element).removeClass('scale_min')
        $(element).removeClass('scale_med')

        if(i==0) $(element).addClass('scale_min')
        if(i==1) $(element).addClass('scale_med')
        if(i==2) $(element).addClass('active')
        if(i==3) $(element).addClass('scale_med')
        if(i==4) $(element).addClass('scale_min')
